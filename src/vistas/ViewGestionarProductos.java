 ...
 */
    ...
    File archivo = new File("data/productos.csv");
     ...
     private void agregarCampo() {
        ...
        try {
            ...
            try {
                ...
                escribirArchivo.write("PRODUCTOID" + "," + "NOMBRE" + "," + "DESCRIPCION" + "," + "CANTIDAD" + "," + "PRECIO/UNIDAD" + "," + "TOTAL" + "\n");
        ...
        if (numeroRegistros == 0) {
            ...
            while ((strLine = leerFichero.readLine()) != null) {
                ...
                while (st.hasMoreTokens()) {
                    tokenNumber++;
                    datos[posicion][0] = st.hasMoreTokens() ? st.nextToken().trim() : "";
                    datos[posicion][1] = st.hasMoreTokens() ? st.nextToken().trim() : "";
                    datos[posicion][2] = st.hasMoreTokens() ? st.nextToken().trim() : "";
                    datos[posicion][3] = st.hasMoreTokens() ? st.nextToken().trim() : "";
                    datos[posicion][4] = st.hasMoreTokens() ? st.nextToken().trim() : "";
                    datos[posicion][5] = st.hasMoreTokens() ? st.nextToken().trim() : "";
                    posicion += 1;
                }
                tokenNumber = 0;
            }
   ...
   public void limpiarTabla(DefaultTableModel modelo) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 820, -1));

        jLabel2.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel2.setText("Producto ID");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, -1, -1));

        txtProductoID.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        txtBuscarProductos.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
...
private void actualizarCamposDeTexto(int filaSeleccionada) {
    txtProductoID.setText((String) tblProductos.getValueAt(filaSeleccionada,1));
    txtNombre.setText((String)tblProductos.getValueAt (filaSeleccionada,2));
    txtDescripcion.setText((String)tblProductos.getValueAt (filaSeleccionada,3));
    txtCantidad.setText((String) tblProductos.getValueAt(filaSeleccionada, 4));
    txtPrecioUnidad.setText((String) tblProductos.getValueAt(filaSeleccionada, 5));
    txtTotal.setText((String) tblProductos.getValueAt(filaSeleccionada, 6));
}

 
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
    String buscar = String.valueOf(txtBuscarProductos.getText());
    String[][] datos = new String[tblProductos.getRowCount()][6];
...
private void ingresarProductos() {
        ...
        try {
            ...
            try {
                System.out.println("clases.GestionarProductos.ingresarProductos(): ");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (!(txtProductoID.getText().equals("") || txtNombre.getText().equals("") || txtDescripcion.getText().equals("") || txtCantidad.getText().equals("") || txtPrecioUnidad.getText().equals("") || txtTotal.getText().equals(""))) {
            if (opcionBoton.equals("Agregar")) {
                ...
                efectuarEdicion();
                almacenarFichero();
                JOptionPane.showMessageDialog(null, "Se ha editado el producto satisactoriamente");
            }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        // TODO add your handling code here:
         int respuesta = JOptionPane.showConfirmDialog(null, "En serio desea eliminar este producto", "Eliminar producto", JOptionPane.YES_NO_OPTION);
    ...
    private void txtPrecioUnidadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtPrecioUnidadActionPerformed
     ...
     public void almacenarFichero() {
        try {
            ...
            for (int i = 0; i < tblProductos.getRowCount(); i++) {
                escribirArchivo.write(tblProductos.getValueAt(i, 1) + "," + tblProductos.getValueAt(i, 2) + "," + tblProductos.getValueAt(i, 3) + "," + tblProductos.getValueAt(i, 4) + "," + tblProductos.getValueAt(i, 5) + "," + tblProductos.getValueAt(i, 6) + "\n");
            }
            escribirArchivo.close();
            leerArchivo();
        } catch (IOException ex) {
    ...
    for (int i = 0; i < tblProductos.getRowCount(); i++) {
        if (Integer.parseInt((String) tblProductos.getValueAt(i, 0)) == numeroEditar) {
                tblProductos.setValueAt(i + 1, i, 0);
