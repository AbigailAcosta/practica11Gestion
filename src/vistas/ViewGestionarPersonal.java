...
public class ViewGestionarPersonal extends JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(3, 10, 910, -1));
        ...
        txtCedula.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
        ...
        jPanel1.add(txtCedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 50, 260, -1));
        ...
        txtApellidoPaterno.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
        txtApellidoPaterno.setEnabled(false);
        jPanel1.add(txtApellidoPaterno, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 80, 260, -1));

        jLabel5.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel5.setText("Fecha Nacimiento");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, -1, -1));

        txtApellidoMaterno.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
        ...
        txtFechaNacimiento.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
        txtFechaNacimiento.setEnabled(false);
        jPanel1.add(txtFechaNacimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 260, -1));
        ...
        txtTeleFijo.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
        txtTeleFijo.setEnabled(false);
        jPanel1.add(txtTeleFijo, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, 260, -1));

        jLabel9.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel9.setText("Fecha Ingreso");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, -1, -1));

        txtTeleMovil.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
        ...
        txtFechaIngreso.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
        txtFechaIngreso.setToolTipText("");
        txtFechaIngreso.setEnabled(false);
        jPanel1.add(txtFechaIngreso, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 170, 260, -1));
        ...
        txtBuscarPersonal.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 50, 80, -1));
        ...
        jPanel1.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 280, 110, 30));

        cboCargo.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (!(txtCedula.getText().equals("") || txtNombre.getText().equals("") || txtApellidoPaterno.getText().equals("") || txtApellidoMaterno.getText().equals("") || txtFechaNacimiento.getText().equals("") || txtDireccion.getText().equals("") || txtTeleFijo.getText().equals("") || txtTeleMovil.getText().equals("") || txtFechaIngreso.getText().equals("") || cboCargo.getSelectedItem().toString().equals(""))) {
            if (opcionBoton.equals("Agregar")) {
                ...
                efectuarEdicion();
                almacenarFichero();
                JOptionPane.showMessageDialog(null, "Se ha editado el personal satisactoriamente");
            }
